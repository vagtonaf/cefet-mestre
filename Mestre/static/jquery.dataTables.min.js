...
}}else{if(mData.length!=oSettings.aoColumns.length){alert("Atenção: Uma matriz passada para fnUpdate deve ter o mesmo número de colunas que a tabela em questão - neste caso"+oSettings.aoColumns.length);
...
}}}function _fnAddData(oSettings,aData){if(aData.length!=oSettings.aoColumns.length){alert("Aviso - dados adicionados não corresponder conhecido número de colunas");
